    ...
    <div className="min-h-screen bg-blue-50">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
              ...
              className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-3 px-8 rounded-lg text-lg transition-colors"
            >
              Watch Demo
            </button>
          </div>
      ...
      <footer className="px-6 py-8 bg-gray-900">
        <div className="max-w-7xl mx-auto text-center text-gray-400">
          <p>Interactive Product Tour Platform</p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-2xl mx-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-2xl font-bold text-gray-900">Product Tour Demo</h3>
              <button 
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <ul className="text-blue-800 space-y-1">
                  <li>• Upload screenshots and images</li>
                  <li>• Add interactive annotations (highlights, arrows, text)</li>
                  <li>• Record your screen directly in the browser</li>
                  <li>• Create step-by-step product tours</li>
                  <li>• Share tours with public or private links</li>
                </ul>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-green-900 mb-2">🚀 Get Started:</h4>
                <p className="text-green-800">
                  Click "Get Started" to create your account and start building interactive product tours in minutes!
                </p>
              </div>
